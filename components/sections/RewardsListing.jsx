        ...
        <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
          <nav>
            ...
            <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
              ...
              <li class="text-sm pl-2 capitalize leading-normal text-slate-700 before:float-left before:pr-2 before:text-gray-600 before:content-['/']" aria-current="page">Credits</li>
            </ol>
            <h6 class="mb-0 font-bold capitalize">Credits</h6>
          </nav>
    ...
    <div className="flex-none w-full max-w-full px-3 mt-6">
      <div className="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
        <div className="p-4 pb-0 mb-0 bg-white rounded-t-2xl">
          <h6 className="mb-1">Claim Rewards Now</h6>
              ...
              <div className="relative flex flex-col min-w-0 break-words bg-transparent border-0 shadow-none rounded-2xl bg-clip-border">
                <div className="relative">
                  <a className="block shadow-xl rounded-2xl">
                    ...
                    <Image src="/images/GiftCard.jpg" alt="img-blur-shadow" width={500} height={500} className="max-w-full shadow-soft-2xl rounded-2xl" />
                  </a>
                </div>
                <div className="flex-auto px-1 pt-6">
                  <p className="relative z-10 mb-2 leading-normal text-transparent bg-gradient-to-tl from-gray-900 to-slate-800 text-sm bg-clip-text">Expires 31 April 2024</p>
                  <a href="javascript:;">
                    <h5>Amazon Gift Rs 1000</h5>
                    <h6>10000 credits</h6>
                  </a>
                  <p className="mb-6 leading-normal text-sm">Get ready to shop till you drop with our exclusive offer! Purchase an Amazon Gift Card worth Rs 1000 and unlock a world of endless possibilities.</p>
